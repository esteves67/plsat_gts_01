...
public class DBFieldValues
{
    ...
    **/
    ...
    {
//        Print.logInfo("entrando a public DBField getField(String fldName).....................");
        if (this.recordKey != null) {
...
//        Print.logInfo("fldName...........:" + fldName);
        Object oldVal = this._getFieldValue(fldName, true);
//        Print.logInfo("newVal...........:" + newVal);
//        Print.logInfo("oldVal...........:" + oldVal);
        this.valueMap.put(fldName, newVal);
//        Print.logInfo("valueMap..................:" + valueMap);
    ...
    **/
    ...
    {
        Print.logInfo("entrando a public String getFieldName(String fldName) ..................");
        if (fldName != null) {
...
//        Print.logInfo("fldName...............:" + fldName);
        ...
        if (val != null) {
 //           Print.logInfo("_getFieldValue ...................1");
            // field value found (or undefined)
            return val;
        } else
        if (this.hasField(fldName)) {
//            Print.logInfo("_getFieldValue ...................2");
        ...
        if (requiredField && !this.getIgnoreInvalidFields()) {
            Print.logInfo("_getFieldValue ...................3");
            Print.logStackTrace("Field not found: " + fldName);
            return null;
        } else {
            Print.logInfo("_getFieldValue ...................4");
            return null;
        }
    }
...
//                Print.logInfo("entrando al segundo if..........");
        ...
        /* return object */
//        Print.logInfo("sin entrar al primer if");
        return obj;
    ...
    **/
    ...
    {
//        Print.logInfo("entrando a dbtools/DBFieldValues.java ....... fldName: " + fldName);
