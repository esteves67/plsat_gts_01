    ...
    **/
        ...
        boolean outputHtml)
    {
        ...
        if (!StringTools.isBlank(legendTitle)) {
            if (outputHtml) {
                sb.append("<span style=\"display: none;\"  id=\"LegendPushpins\"  class=\""+CSS_legend+"\">" + legendTitle + " <a href='#' onclick=\"javascript:document.getElementById('LegendPushpins').style.display='none';javascript:document.getElementById('mapProviderLegendT').style.display='none';\" target='_self' style='cursor:pointer;'> (Ocultar) </a> </span>\n");
		   } else {
        ...
        /* begin icon table */
        if (outputHtml) {
            sb.append("<table style=\"display: none;\" id=\"mapProviderLegendT\" class=\""+CSS_legend+"\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\">\n");
        } else {
            //
        }
