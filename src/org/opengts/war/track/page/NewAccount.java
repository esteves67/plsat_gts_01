    ...
    implements Constants
{
        ...
        String name, String email, String auth)
    {
        ...
        byte acm[] = null;
        try {
            acm = org.opengts.util.Base64.decode(privLabel.getStringProperty(PrivateLabel.PROP_NewAccount_authCodeMask,null));
        ...
        } catch (org.opengts.util.Base64.Base64DecodeException bde) {
        ...
        byte uac[] = null;
        try {
            uac = org.opengts.util.Base64.decode(auth);
    ...
    public static void main(String argv[])
    {
        ...
        byte acm[] = null;
        try {
            acm = org.opengts.util.Base64.decode(bpl.getStringProperty(PrivateLabel.PROP_NewAccount_authCodeMask,null));
            if (ListTools.isEmpty(acm)) {
        ...
        if (RTConfig.hasProperty(ARG_DECODE)) {
            ...
            String uac64 = StringTools.stripChars(org.opengts.util.Base64.encode(uac),'=');
