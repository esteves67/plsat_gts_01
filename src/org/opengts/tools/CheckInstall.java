...
public class CheckInstall
{
    ...
    public static void main(String argv[])
    {
        ...
        if (defaultProps != null) {
            ...
            if (smsType.equals(SMSOutboundGateway.GW_met)) { // MET (Mensajeria Empresarial Telcel)
                sms.append(", URL XML-RPC=");
                sms.append(defaultProps.getString(SMSOutboundGateway.PROP_met_url,""));
                sms.append(", User=");
                sms.append(defaultProps.getString(SMSOutboundGateway.PROP_met_user,""));
                sms.append(", Pass=");
                sms.append("xxxxxxxxxxxx"); //sms.append(defaultProps.getString(SMSOutboundGateway.PROP_met_password,""));                
                smsIsFunctional = 1;
            } else
