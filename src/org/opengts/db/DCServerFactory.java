...
public class DCServerFactory
{
  ...
  //public static final String  TAIP_NAME                       = "taip";           // [3x275] 
    ...
    public static final String  ENFORA8750_NAME                 = "enfora8750";         // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  SUNTECH_NAME                    = "suntech";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  SUNTECHST300KE_NAME             = "suntechst300ke";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  SUNTECHST330_NAME               = "suntechst330";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  SUNTECHST330V148_NAME           = "suntechst330v148";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  SUNTECHST600R_NAME              = "suntechst600r";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  SUNTECHST910_NAME               = "suntechst910";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  TRACER_NAME                     = "tracer";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
    public static final String  TK104_NAME                      = "tk104";        // [3x400] (31400) MT-Gu, MT-uL, Mini-MT
...
//        Print.logWarn("hash..............");
//        for (Map.Entry<String,DCServerConfig> entry : DCServerFactory.dcServerMap.entrySet()) {
//          String key = entry.getKey().toString();
//          DCServerConfig value = entry.getValue();
//          Print.logWarn("llave: " + key + ", valor: " + value);
//        }
    ...
    **/
    private static DCServerConfig addDCS(DCServerConfig dcs)
    {
        ...
        if (DCServerFactory._DCServerMap(false).containsKey(name)) {
            // ignore duplicate entries
            Print.logWarn("Ignoring duplicate DCServer: " + name);
            return null;
        }
    ...
    **/
    ...
    {
        Print.logInfo("NAME..........: " + name);
//        Print.logWarn("GET NAME..........: " + DCServerFactory._DCServerMap(true).get(name));
    ...
    **/
    ...
    {
        Print.logInfo("entrando a getServerConfig.......: " + name);
        if (StringTools.isBlank(name)) {
