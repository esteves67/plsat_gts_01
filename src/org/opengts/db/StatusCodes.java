...
// ----------------------------------------------------------------------------
    ...
    private static Code _codeArray[] = new Code[] {
      ...
      //new PairedStatusCodes(STATUS_DOOR_OPEN_1        , STATUS_DOOR_CLOSE_1       , CAT_Door_1    , I18N.getString(StatusCodes.class,"StatusCodes.PairedStatusCodes.Door_1"    ,"Door Open/Close")),
        ...
        new Code(STATUS_DOOR_OPEN_0         , "DOOR.OPEN.0"  , I18N.getString(StatusCodes.class,"StatusCodes.doorOpen_0"        ,"Puerta Izquierda Abierta"         ), true ), // (on ) 
        new Code(STATUS_DOOR_OPEN_1         , "DOOR.OPEN.1"  , I18N.getString(StatusCodes.class,"StatusCodes.doorOpen_1"        ,"Puerta Derecha Abierta"       ), true ), // (on ) 
        new Code(STATUS_DOOR_CLOSE_0        , "DOOR.CLOSE.0" , I18N.getString(StatusCodes.class,"StatusCodes.doorClose_0"       ,"Puerta Izquierda Cerrada"        ), true ), // (off) 
        new Code(STATUS_DOOR_CLOSE_1        , "DOOR.CLOSE.1" , I18N.getString(StatusCodes.class,"StatusCodes.doorClose_1"       ,"Puerta Derecha Cerrada"      ), true ), // (off)
