    ...
    implements DataTransport
{
  ...
  //public static final String FLD_smsGatewayProps       = "smsGatewayProps";       // SMS gateway properties
    ...
    {
//        Print.logInfo("entrando a getDeviceCode...........");
        String v = (String)this.getFieldValue(FLD_deviceCode);  // serverID
//        Print.logInfo("FLD_deviceCode..........." + FLD_deviceCode);
//        Print.logInfo("v........................" + v);
        return StringTools.trim(v);
    }
    ...
    **/
    public void setLastOdometerKM(double odomKM)
    {
        if (odomKM < this.getMaxOdometerKM()) {
            Print.logInfo("+++++++++++++fijar odometro: "+odomKM+" :: "+this.getMaxOdometerKM());
    ...
    **/
    public double adjustOdometerKM(double odomKM, boolean checkLast)
    {
        ...
        Print.logInfo("db device table" + odomKM + " --- " + lastOdomKM);
        if (checkLast && (odomKM < lastOdomKM)) {
            Print.logInfo("db device table primer if...." + lastOdomKM);
            return lastOdomKM;
        } else
        if (odomKM >= this.getMaxOdometerKM()) {
            Print.logInfo("db device table segundo if...." + lastOdomKM);
            return lastOdomKM;
        } else {
            Print.logInfo("db device table else...." + odomKM);
            return odomKM;
        }
    }
    ...
    **/
    ...
    {
//        Print.logInfo("entrando a getDCServerConfig................");
    ...
    **/
    public Map<String,String> getSupportedCommands(BasicPrivateLabel privLabel, User user, 
        String type)
    {
        Print.logInfo("getSupportedCommands.............................");
        DCServerConfig dcs = this.getDCServerConfig();
        if (dcs != null) {
          Print.logInfo("diferente de nulo.............................");
        } else {
          Print.logInfo("nulo.............................");
        }
    ...
    **/
    protected boolean _insertEventData(final EventData evdb)
    {
        ...
        Print.logInfo(">>>>>>>>>>>>>>>>>>>>>> comienza guardado");
        ...
        if (evdb.getOdometerKM() > 0.0) {
            Print.logInfo("dato a guardar..................:" + evdb.getOdometerKM());
