...
// ----------------------------------------------------------------------------
package org.opengts.servers.suntechst330;
...
//    }
    ...
    if (s.contains("SA200")) {
      if (s.contains("ALV")) {
        ...
        return this.parseInsertRecord_Suntechst330(s);
      }
    }
      return null;
    }
    ...
    private byte[] parseInsertRecord_Suntechst330(String s)
    {   
        // Ascii Data:	
        // Example:
        // -------  
        ...
        Print.logInfo("Parsing(Suntechst330): " + s);
