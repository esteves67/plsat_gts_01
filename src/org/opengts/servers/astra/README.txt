...
by the remote tracking devices. This is set in the top-level "dcservers_release.xml" file,
...
"dcservers_release.xml" file the -port argument can be used from the command line as
follows:
