...
//    }
    ...
    if (s.contains("ST300")) {
      if (s.contains("ALV")) {
        ...
        return this.parseInsertRecord_Suntechst330v148(s);
      }
    }
      return null;
    }
    ...
    private byte[] parseInsertRecord_Suntechst330v148(String s)
    {   
        // Ascii Data:	
        // Example:
        // -------  
        ...
        Print.logInfo("Parsing(Suntechst330v148): " + s);
...
//		boolean validGPS    = fld[3].equalsIgnoreCase("A");	
        double  latitude    = Double.parseDouble(fld[7+is_cmd]);
        double  longitude   = Double.parseDouble(fld[8+is_cmd]);
        double  headingDeg  = Double.parseDouble(fld[10+is_cmd]);
        double  speedKPH    = Double.parseDouble(fld[9+is_cmd]);
		double  hDOP        = 0.0;
		int     numSats     = Integer.parseInt(fld[11+is_cmd]);
                int     gpsFix  = Integer.parseInt(fld[12+is_cmd]);
        double  altitudeM   = 0.0;		
		double  odomM      = Double.parseDouble(fld[13+is_cmd]); // fld[13].substring(4, fld[0].length()); /* Odometer Virtual GPS*/
        ...
        if (is_cmd == 1) {
          ...
          } else if (reportType.contains("EMG") && eventType.equals("3")) {
          ...
          } else if (reportType.contains("ALT") && eventType.equals("14")) {
