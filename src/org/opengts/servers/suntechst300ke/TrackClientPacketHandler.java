...
// ----------------------------------------------------------------------------
package org.opengts.servers.suntechst300ke;
...
//    }
    ...
    if (s.contains("ST300")) {
      if (s.contains("ALV")) {
        ...
        return this.parseInsertRecord_Suntechst300ke(s);
      }
    }
      return null;
    }
    ...
    private byte[] parseInsertRecord_Suntechst300ke(String s)
    {   
        // Ascii Data:	
        // Example:
        // -------  
        ...
        Print.logInfo("Parsing(Suntechst300ke): " + s);
...
//		boolean validGPS    = fld[3].equalsIgnoreCase("A");	
        ...
        if (is_cmd == 1) {
          ...
          } else if (reportType.contains("EVT") && eventType.equals("5")) {
              statusCode  = StatusCodes.STATUS_DOOR_OPEN_1;
          } else if (reportType.contains("EVT") && eventType.equals("6")) {
