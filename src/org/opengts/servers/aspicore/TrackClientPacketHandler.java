...
//  http://URL/Data?imei=123456789012345&lat=40.172740&lon=142.761930&status=A&speed=000.0&course=189.8&time=081055.668&date=250907 
//
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
    ...
    extends AbstractClientPacketHandler
{
    ...
    private boolean insertData()
    {
        ...
        /* [ENTERPRISE] estimate GPS-based odometer */
        if (odomKM <= 0.0) {
        ...
        /* [ENTERPRISE] simulate Geozone arrival/departure */
