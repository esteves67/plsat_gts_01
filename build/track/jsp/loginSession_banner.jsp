...
<head>
  ...
  <style type="text/css">
    ...
    TD.titleText {       
        background: #DBDEEB url('./images/Logo.png') center no-repeat;
...
<tbody>
  ...
  <tr>
  <td width="100%">
    <table class="bannerTable" width="860" border="0" cellpadding="0" cellspacing="0" align="center" id="banner">
    <tbody>
    <tr>
      ...
      <td width="860" height="120" class="titleText" halign="center">
        <!-- ${pageTitle}<br> -->
        <font style="font-size: 9pt;"><i>(Powered by <a href="http://www.unlimitbyte.com" target="_blank" style="color:#444444;">UNLIMITBYTE</a>)</i></font>
      </td>
      </gts:var>
  ...
  <tr>
  <td align="center">
     <table width="860" border="0" cellpadding="0" cellspacing="0" id="navigation">
     <tbody>
     <tr>
